...
public class RoleController {
    ...
    public Result<Page<RoleDTO>> list(@ModelAttribute RoleQueryParams params) {
        Page page = roleDomainService.list(params);
    ...
    public Result get(@PathVariable String id) {
        Optional<SysRole> sysRoleInfo = roleDomainService.getById(id);
    ...
    public Result selectAll( @NotNull(message = "角色ID必填") Long roleId,
        ...
        roleDomainService.selectUser(roleId,userIds);
    ...
    public Result add(@RequestBody @Valid SysRoleDTO sysRoleDTO) {
        ...
        if (GlobalConst.NOT_UNIQUE.equals(roleDomainService.checkRoleCodeUnique(new SysRole(sysRoleDTO.getCode())))) {
            return ResultUtil.fail(StrUtil.format("角色编码:{}已存在", sysRoleDTO.getCode()));
        }

        roleDomainService.add(sysRoleDTO);
    ...
    public Result update(@RequestBody @Validated SysRoleDTO sysRoleDTO) {
        if (GlobalConst.NOT_UNIQUE.equals(roleDomainService.checkRoleCodeUnique(new SysRole(sysRoleDTO.getId(), sysRoleDTO.getCode())))) {
            return ResultUtil.fail(StrUtil.format("角色编码:{}已存在", sysRoleDTO.getCode()));
        }

        roleDomainService.update(sysRoleDTO);
    ...
    public void export(@ModelAttribute RoleQueryParams params, HttpServletResponse response) throws IOException {
        Page<RoleDTO> page = roleDomainService.list(params);
