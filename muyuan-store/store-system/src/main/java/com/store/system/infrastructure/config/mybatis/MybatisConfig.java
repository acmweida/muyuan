package com.store.system.infrastructure.config.mybatis;
...
public class MybatisConfig {
    ...
    @Bean
    public DataSource dataSource(com.store.system.infrastructure.config.mybatis.MemberJdbcConfig jdbcConfig) {
        ...
        dataSourceMap.put(com.store.system.infrastructure.config.mybatis.MemberJdbcConfig.DATASOURCE_NAME,memberDataSource);
    ...
    @Bean
    @ConditionalOnBean(com.store.system.infrastructure.config.mybatis.MemberReadWriteJdbcConfig.class)
    @ConditionalOnMissingBean(DataSource.class)
    public DataSource dataSource(com.store.system.infrastructure.config.mybatis.MemberReadWriteJdbcConfig memberJdbcConfig) {
        DynamicDataSource dataSources = new DynamicDataSource();
        Map<Object,Object> dataSourceMap = new HashMap<>();
        ...
        dataSourceMap.putAll(addDataSourceConfig(memberJdbcConfig, com.store.system.infrastructure.config.mybatis.MemberReadWriteJdbcConfig.DATASOURCE_NAME,config));
