...
import com.muyuan.common.core.exception.FailException;
import com.muyuan.common.core.util.CharsetKit;
import com.muyuan.common.core.util.JSONUtil;
import com.muyuan.common.mybatis.jdbc.SqlParamsBuilder;
import com.muyuan.common.web.util.SecurityUtils;
import com.muyuan.system.base.constants.GenConstants;
import com.muyuan.system.base.util.GenUtils;
import com.muyuan.system.base.util.VelocityInitializer;
import com.muyuan.system.base.util.VelocityUtils;
import com.muyuan.system.dao.GenTableColumnMapper;
import com.muyuan.system.dao.GenTableMapper;
import com.muyuan.system.dao.converter.GenTableConverter;
import com.muyuan.system.dto.GenTableDTO;
import com.muyuan.system.entity.GenTable;
import com.muyuan.system.entity.GenTableColumn;
import com.muyuan.system.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public Page<GenTable> selectGenTableList(GenTableDTO genTableDTO) {
        ...
        List<GenTable> genTables = genTableMapper.selectGenTableList(genTableDTO);
    ...
    public Page<GenTable> selectDbTableList(GenTableDTO genTable) {
        ...
        page.setRows(genTableMapper.selectDbTableList(new SqlParamsBuilder<GenTableDTO>()
    ...
    public void updateGenTable(GenTableDTO genTable) {
        ...
        int row = genTableMapper.updateById(converter.to(genTable));
        if (row > 0) {
    ...
    public void deleteGenTableByIds(Long[] tableIds) {
        ...
        genTableColumnMapper.deleteBatchIds(Arrays.asList(tableIds));
    }
