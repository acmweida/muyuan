...
public class MenuServiceImpl implements MenuService {
    ...
    public List<Menu> getMenuByRoleId(Long roleId) {
        List<Permission> permissionByRoles = permissionService.getPermissionByRoleID(new RoleID(roleId));
    ...
    public List<Menu> getMenuByUserId(UserID userID,PlatformType platformType) {
        List<Role> roles = roleService.selectRoleByUserId(userID, platformType);

        List<Menu> menus = new ArrayList<>();
        for (Role role : roles) {
            List<Permission> permissionByRoles = permissionService.getPermissionByRoles(role);
