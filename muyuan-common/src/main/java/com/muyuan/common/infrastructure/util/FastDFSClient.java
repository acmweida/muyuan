package com.muyuan.common.infrastructure.util;

import com.muyuan.common.constant.CommonConst;
import com.muyuan.common.thread.CommonThreadPool;
import com.muyuan.common.util.CollectionAssert;
...
public class FastDFSClient {
    ...
    public String uploadFile(String group,String fileExtendName,InputStream fileStream) throws MyException, IOException {
        Assert.isTrue(fileStream.available() <= CommonConst.MB,"file size > 1MB");
    ...
    static class UploadFaction implements UploadCallback {
        ...
        public int send(OutputStream outputStream) throws IOException {
            int readByteCount = fileStream.read(temp, start, (int) CommonConst.KB);
    ...
    static class UploadTask extends UploadFaction implements  Callable<String> {
        ...
        public String call() throws Exception {
            return  storageClient1.upload_file1(group, fileStream.available(),new UploadFaction(fileStream), fileExtendName, new NameValuePair[]{});
        }
    }
}
