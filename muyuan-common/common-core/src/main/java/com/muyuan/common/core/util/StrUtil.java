...
public class StrUtil  extends StringUtils {
    ...
    public static String stringFormat(String format,Object ... args) {
         return StrFormatter.format(format, args);
    }
    ...
    {
        return StringUtils.startsWithAny(link, GlobalConst.HTTP, GlobalConst.HTTPS);
    }
   ...
   static class StrFormatter
    {
        ...
        {
            if (StrUtil.isEmpty(strPattern) || StrUtil.isEmpty(argArray))
            {
                return strPattern;
            }
