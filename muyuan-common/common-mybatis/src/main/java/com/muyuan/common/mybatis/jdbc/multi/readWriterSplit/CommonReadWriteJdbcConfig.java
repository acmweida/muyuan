 ...
 */
@Component
@ConfigurationProperties(prefix = "common.jdbc.muti")
@ConditionalOnProperty(prefix = "common.jdbc",value = "muti")
public class CommonReadWriteJdbcConfig extends ReadWriteJdbcConfig {
