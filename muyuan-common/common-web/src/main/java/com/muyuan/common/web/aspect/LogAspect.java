...
public class LogAspect
{
    ...
    private OperLogInterface asyncLogService;
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        ...
        {
            // *========数据库日志=========*//
            OperLogRequest operLog = new OperLogRequest();
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, OperLogRequest operLog, Object jsonResult) throws Exception
    {
        // 设置action动作
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, OperLogRequest operLog) throws Exception
    {
