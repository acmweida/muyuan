...
public class ServletUtils
{
    ...
    public static String urlEncode(String str)
    {
        try
        {
            return URLEncoder.encode(str, GlobalConst.UTF8);
        }
    ...
    public static String urlDecode(String str)
    {
        try
        {
            return URLDecoder.decode(str, GlobalConst.UTF8);
        }
        catch (UnsupportedEncodingException e)
        {
            return StrUtil.EMPTY;
    ...
    {
        return webFluxResponseWriter(response, HttpStatus.OK, value, ResponseCode.ERROR.getCode());
    }
